...
import { Heart, Calendar, Settings, MapPin, Plus, Trash2, X, Image as ImageIcon, Clock, Palette, Pencil, Check, Armchair, Ticket, Type, DollarSign, TrendingUp, Coins, Trophy, Map, ListMusic, Maximize2 } from 'lucide-react'; // ✨ 加了 Type 圖示
                    ...
                    <div className="grid grid-cols-2 gap-4 animate-in fade-in zoom-in duration-500">
                        ...
                        <div className="col-span-2 bg-white p-6 rounded-3xl shadow-sm border border-slate-100 relative overflow-hidden group">
                            ...
                            <div className="flex items-center gap-2 text-slate-400 mb-2">
                                <Coins size={18} />
                                <span className="text-xs font-bold uppercase tracking-wider">累積花費 (Total Spending)</span>
                            </div>
                            ...
                            <p className="text-xs text-slate-400 mt-2">為愛發電的證明 💸</p>
                        </div>
                        ...
                        <div className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 group hover:border-pink-200 transition-colors">
                            ...
                            <span className="text-xs text-slate-400 font-bold uppercase">參加場次 (Events)</span>
                        </div>
                        ...
                        <div className="bg-white p-5 rounded-3xl shadow-sm border border-slate-100 flex flex-col items-center justify-center gap-2 group hover:border-blue-200 transition-colors">
                            ...
                            <span className="text-xs text-slate-400 font-bold uppercase">踩點場館 (Venues)</span>
                        </div>
                        ...
                        {activeTab === 'wallet' && (
                            <div className="space-y-3 bg-slate-50 p-3 rounded-xl border border-slate-100">
                                ...
                                <div className="relative">
                                    ...
                                    <input name="venue_input" placeholder="地點 (例如：高雄巨蛋)" className="w-full p-3 pl-9 bg-white rounded-xl outline-none text-sm focus:ring-2 focus:ring-slate-100 transition-shadow border border-slate-200" />
                                </div>
                                <div className="flex gap-3">
                                    <div className="relative flex-1">
                                        <Ticket size={16} className="absolute left-3 top-3.5 text-slate-400" />
                                        <input name="zone_input" placeholder="區域 (例如：1樓 E10區)" className="w-full p-3 pl-9 bg-white rounded-xl outline-none text-sm focus:ring-2 focus:ring-slate-100 transition-shadow border border-slate-200" />
                                    </div>
                                    <div className="relative flex-1">
                                        <Armchair size={16} className="absolute left-3 top-3.5 text-slate-400" />
                                        <input name="seat_input" placeholder="座位 (例如：9排 20號)" className="w-full p-3 pl-9 bg-white rounded-xl outline-none text-sm focus:ring-2 focus:ring-slate-100 transition-shadow border border-slate-200" />
                                    </div>
                                </div>
                                {/* ✨ 新增：票價輸入框 */}
                                <div className="relative">
